      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-5 flex items-end justify-between gap-4">
          <div>
            ...
            <p className="text-sm font-medium text-[var(--color-text-muted)]">Khám phá những địa điểm phù hợp cho hành trình tiếp theo.</p>
          </div>
        </div>
        ...
        {status === 'success' && places.length === 0 && (
          <div className="rounded-2xl border border-dashed border-[var(--color-border)] bg-[var(--color-surface)] px-4 py-10 text-center">
            <p className="text-sm font-semibold text-[var(--color-text-secondary)]">Chưa có gợi ý phù hợp.</p>
          </div>
        )}

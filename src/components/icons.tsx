...
export const WeatherIcon = ({ code, className = 'w-10 h-10' }: { code: number; className?: string }) => {
  if (code === 0) {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  if (code >= 1 && code <= 3) {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <path d="M12 3v2M12 19v2M4.22 5.64l1.42-1.42M17.36 18.36l1.42-1.42" />
      </svg>
    );
  }
  if (code === 45 || code === 48) {
  ...
  if ((code >= 51 && code <= 67) || (code >= 80 && code <= 82)) {
    return (
      <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M18 10h-1.26A8 8 0 1 0 9 20h9a5 5 0 0 0 0-10z" />
        <path d="M8 15l2 3M12 15l2 3M16 15l2 3" />
      </svg>
    );
  }
  if (code >= 95 && code <= 99) {
...
export const HeartFilledIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (

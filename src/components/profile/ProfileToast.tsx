...
export default function ProfileToast({ message, visible }: ProfileToastProps) {
  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex items-center gap-3 bg-[var(--color-success)]/10 border border-[var(--color-success)]/30 text-[var(--color-text)] px-6 py-4 rounded-2xl shadow-lg animate-fade-in">

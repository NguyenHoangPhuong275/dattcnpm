  ...
  return (
    <div className="w-full flex-shrink-0 lg:w-56">
      ...
      <div className="space-y-1 text-sm">
        <TabButton tab="personal" label="Thông tin của bạn" isActive={activeTab === 'personal'} onClick={onTabChange} />
        <TabButton tab="preferences" label="Sở thích du lịch" isActive={activeTab === 'preferences'} onClick={onTabChange} />
        <TabButton tab="trips" label="Danh sách chuyến đi" isActive={activeTab === 'trips'} onClick={onTabChange} />
